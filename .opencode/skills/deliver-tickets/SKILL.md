...
2. **All code is `/tdd`.** Follow `.opencode/skills/tdd/SKILL.md` (this repo). Vertical slices: one test → one implementation. Behavior through public interfaces. No horizontal "all tests then all code".
...
Read, in order: the ticket, `.opencode/skills/tdd/SKILL.md`, `docs/CONTEXT.md`, relevant ADRs, `.cursor/rules/*.mdc`.
