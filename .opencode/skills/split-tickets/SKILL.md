...
- **i18n contract** — if the plan has one, tickets that add UI **copy those EN/FR values**. They do not invent new wording. If the epic clearly adds user-facing copy and the plan has no contract, stop and run `.opencode/skills/microcopy/SKILL.md` before writing tickets.
