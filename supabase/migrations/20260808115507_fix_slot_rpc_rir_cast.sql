-- #463 — fix get_last_performance_for_slots plpgsql type mismatch.
-- set_logs.rir is smallint; RETURNS TABLE declares integer.
-- Applied on prod via MCP as this version; file was never committed.
