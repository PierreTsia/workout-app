-- Fix "column reference is ambiguous" error in both RPCs.
-- PL/pgSQL RETURNS TABLE column names shadow table column names;
-- #variable_conflict use_column tells PL/pgSQL to prefer table columns.
