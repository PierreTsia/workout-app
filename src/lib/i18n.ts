...
i18n
  ...
  .init({
    ...
    fallbackLng: "en",
    supportedLngs: ["en", "fr"],
    ns: ["common", "auth", "workout", "history", "builder", "settings", "about", "exercise", "admin", "feedback", "error", "onboarding", "library", "generator", "create-program", "account", "privacy", "achievements", "api-tokens", "catalog", "profile", "program"],
    defaultNS: "common",
