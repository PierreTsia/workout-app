...
INSERT INTO exercise_alternatives (exercise_id, alternative_exercise_id, equipment_context) VALUES
  ...
  (_ex('Squat barre'),               _ex('Squat au poids du corps'), 'home'),
  (_ex('Soulevé de terre'),          _ex('Gainage planche'), 'home'),
  (_ex('Soulevé de terre roumain'),  _ex('Gainage planche'), 'home'),
  (_ex('Leg Curl assis'),            _ex('Squat au poids du corps'), 'home'),
  -- Minimal (dumbbells)
  (_ex('Squat barre'),               _ex('Fentes haltères'), 'minimal'),
  (_ex('Soulevé de terre'),          _ex('Soulevé de terre roumain'), 'minimal'),
  (_ex('Leg Curl assis'),            _ex('Soulevé de terre roumain'), 'minimal'),
