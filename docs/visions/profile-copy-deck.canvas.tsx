...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    name: "Équilibre",
    verdict: "keep",
    job: "Le volume est-il réparti — et ça bouge vs la même fenêtre, décalée.",
    challenge:
      "Pas « Strength Balance ». History dit déjà Équilibre / Balance. Radar 13 groupes + pill score. Body map et paires restent dans History.",
    rows: [
      ...
      { slot: "Delta", fr: "+{n} vs {fenêtre} préc.", en: "+{n} vs prior {window}" },
