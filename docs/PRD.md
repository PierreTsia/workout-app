...
- Workout session with rest timer
- Supabase backend with RLS
- Offline queue & sync
- Progression tracking & PR detection
- History & analytics dashboard
- Workout builder with full CRUD
- PWA (installable, service worker, theme toggle)
- i18n (FR/EN) + weight unit preference
- Exercise library (600+ exercises, search, filters)
- Exercise content enrichment (YouTube, illustrations, instructions)
- Content feedback system
- CI/CD pipeline (lint, tests, E2E, deploy)
- Admin panel for exercise review
- About page
